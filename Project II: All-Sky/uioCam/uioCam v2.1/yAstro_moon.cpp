...
static int g2plan(double J, struct myplantbl *plan, double *pobj, int flag);
static double g1plan(double J, struct myplantbl *plan);
static int gecmoon(double J, struct myplantbl *lrtab,
	struct myplantbl *lattab, double *pobj);
...
static int
g2plan(double J, struct myplantbl *plan, double pobj[], int flag)
{
...
static double
g1plan(double J, struct myplantbl *plan)
{
	int i, j, k, m, k1, ip, np, nt;
	/* On some systems such as Silicon Graphics, char is unsigned
	by default.  */
...
*/
static int
gecmoon(double J, struct myplantbl *lrtab, struct myplantbl *lattab, double pobj[])
{
	double x;
